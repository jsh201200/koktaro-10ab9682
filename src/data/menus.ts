...
export const MENUS: Menu[] = [
  { id: 0, category: 'A', categoryName: '입구', name: '하울의 한 뼘 운세', icon: '🐣', desc: '오늘 하루 럭키 컬러 & 음식!', detailDesc: '딱 오늘 하루의 기운만 짧고 굵게 리딩해주는 스낵 상담! 럭키 컬러, 럭키 음식, 한 줄 부적까지!', price: 1000, isSnack: true },
...
export const MENU_WELCOME_GUIDES: Record<number, string> = {
  0: "오늘 하루, 네게 어울리는 럭키 컬러와 럭키 음식, 그리고 한 줄 부적을 선물해줄게! 🐣 가벼운 마음으로 오늘의 기운을 받아가~ 네 이름(호칭)을 알려줘! ✨",
  1: "네 이름 속에 숨겨진 운명의 바코드를 읽어볼게. 한자 이름의 획수와 오행이 네 성격과 기운을 어떻게 빚어냈는지, 소름 돋는 팩폭 리딩을 준비했어. 네 진짜 이름(한자 포함)을 알려줄래? 이미 아까 이름을 말해줬다면, 분석에 필요한 '한자'만 더 알려줘도 좋아! ✨",
  2: "네 얼굴과 손에는 네가 살아온 길과 다가올 복이 그대로 새겨져 있어. 거울을 보듯 네 이목구비의 특징이나 손금 모양을 자세히 묘사해줘. 하울이 그 속에 담긴 운의 흐름을 읽어줄게! 🖐️",
  ...
  12: "말 못 하는 우리 아이도 너에게 전하고 싶은 메시지가 있어. 반려동물과 영적 주파수를 맞춰서, 아이의 눈에 비친 네 모습과 아이의 진짜 속마음을 하울이 대신 전달해줄게. 🐾",
  ...
  16: "하울의 모든 내공을 담아 네 인생 전체를 관통하는 리포트를 작성해줄게. 3가지 심층 질문에 대해 가장 깊고 정밀한 답변을 얻을 수 있는 최고의 대우를 경험해봐. 👑",
};
